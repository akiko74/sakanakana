...
Lightbox.prototype = {
	...
	_genListFromLinks : function(d)
	{
		...
		for (var i=0;i<links.length;i++)
		{
			...
			self._imgs[num] = {
				...
				set:rel,
				redirectTo:anchor.getAttribute("redirectTo")
			};
	...
	_createBoxOn : function(obj,option)
	{
		...
		Spica.Event.register(img,'click',function(evt) { if (this.getAttribute('redirectTo')) { location.href = this.getAttribute('redirectTo');} else {self._close(evt); }});
	...
	_show : function(num)
	{
		...
		imag.onload = function() {
			...
			if (self._imgs[self._open].redirectTo) {
				self._img.setAttribute('redirectTo',self._imgs[self._open].redirectTo);
			}
